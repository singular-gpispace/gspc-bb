                   ...
                   GpiMap* runtime)
{
  ...
  if( write_singular_output(std::make_pair((inputList->m[10]).Typ(), static_cast<void*> ((inputList->m[10]).Data())), measure_timings, base_filename, "init") )
    { throw std::runtime_error (ids + ": error reading measure_timings in init!"); }
